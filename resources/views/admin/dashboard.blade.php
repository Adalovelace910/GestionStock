...
<style>
    ...
    .dash .kpi-icon { width: 54px; height: 54px; min-width: 54px; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 1.35rem; color: #fff; }
    ...
    .dash .panel { background: #fff; border: 1px solid #eef0f2; border-radius: 16px; overflow: hidden; box-shadow: 0 1px 3px rgba(15,23,42,.04); height: 100%; }
    ...
    .dash table.dash-table th { text-transform: uppercase; font-size: .7rem; letter-spacing: .04em; color: #adb5bd; font-weight: 600; padding-bottom: .6rem; border-bottom: 1px solid #f1f2f4; }
    .dash table.dash-table td { padding: .55rem 0; border-bottom: 1px solid #f8f9fa; color: #343a40; }
...
<script>
    new Chart(document.getElementById('chartMouvements'), {
        ...
        data: {
            ...
            datasets: [
                { label: 'Entrées', data: @json($moisEntrees), borderColor: '#198754', backgroundColor: 'rgba(25,135,84,.1)', fill: true, tension: .35 },
                { label: 'Sorties', data: @json($moisSorties), borderColor: '#dc3545', backgroundColor: 'rgba(220,53,69,.08)', fill: true, tension: .35 }
            ]
        },
    ...
    new Chart(document.getElementById('chartCategories'), {
        ...
        data: {
            ...
            datasets: [{ data: @json($repartitionCategories->pluck('produits_sum_quantite')), backgroundColor: ['#0d6efd','#198754','#fd7e14','#dc3545','#6f42c1','#20c997'], borderWidth: 0 }]
        },
