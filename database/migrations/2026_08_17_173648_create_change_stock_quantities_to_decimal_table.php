...
return new class extends Migration
{
    public function up(): void
    {
        ...
        if (!Schema::hasColumn('entrees', 'quantite_matiere_premiere')) {
            Schema::table('entrees', function (Blueprint $table) {
                $table->decimal('quantite_matiere_premiere', 10, 2)->nullable()->after('production_id');
            });
        } else {
            Schema::table('entrees', function (Blueprint $table) {
                $table->decimal('quantite_matiere_premiere', 10, 2)->nullable()->change();
            });
        }
    }
    ...
    public function down(): void
    {
        ...
        Schema::table('entrees', function (Blueprint $table) {
            ...
            $table->integer('quantite_matiere_premiere')->nullable()->change();
        });
    }
};